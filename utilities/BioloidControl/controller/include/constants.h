...
// most important: number of ax12 connected to atmega
#define AX12_COUNT 18

// ax12 ids: AX12_STARTID, AX12_STARTID+1, AX12_STARTID+2, ... , AX12_STARTID + AX12_COUNT - 1
#define AX12_STARTID 1
...
#define AX12_DATA_READ 6 // 2 byte per speed, torque and position
#define AX12_DATA_WRITE 6
#define AX12_RETRY 1
#define AX12_NOERROR 0
#define AX12_ERROR 1
#define AX12_READERROR_TIMEOUT 10
...
#define DEFAULT_BAUD_RATE 4 //57600bps at 16MHz, 34=57.6k, 0 = 2MBit, 16 = 115200 7 = 250000 3 = 500000
								//8 230400
////// For CM-5
